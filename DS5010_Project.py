...
class Graph:
    ...
    def set_edges(self, edges):
        '''
        Method -- set_edges
        A set method to set graph's edges
        Parameters: self -- input Graph instance
                    edges (list) -- a list of all edges in a graph
        Set edges attribute for a Graph instance
        '''
        self.edges = edges

    def set_edge_lens(self, edge_lens):
        '''
        Method -- set_edge_lens
        A set method to set graph's edge_lens
        Parameters: self -- input Graph instance
                    edges (list) -- a list of ordered edge lengths
        Set edge_lens attribute for a Graph instance
        '''
        self.edge_lens = edge_lens
